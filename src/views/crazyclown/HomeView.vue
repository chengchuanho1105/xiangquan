...
<template>
  ...
  <div class="max-w-[1024px] container mx-auto p-3">
    ...
    <SectionDefStyle id="home-about" mainTitle="關於我們" subTitle="about" slogan="">
      <div class="p-5">

      </div>
    </SectionDefStyle>

    <SectionDefStyle id="home-event" mainTitle="最新活動" subTitle="event" slogan="">
      <div class="p-5">

      </div>
    </SectionDefStyle>

    <SectionDefStyle id="home-news" mainTitle="最新公告" subTitle="news" slogan="">
      <div class="p-5">
